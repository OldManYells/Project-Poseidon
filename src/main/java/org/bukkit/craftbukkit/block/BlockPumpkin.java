...
public class BlockPumpkin extends net.minecraft.server.CraftBlock {
    ...
    public boolean canPlace(World world, int i, int j, int k) {
        ...
        return (l == 0 || net.minecraft.server.CraftBlock.byId[l].material.isReplacable()) && world.e(i, j - 1, k);
    }
