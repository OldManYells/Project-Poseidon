...
public class BlockFire extends net.minecraft.server.CraftBlock {
    ...
    public void h() {
        this.a(net.minecraft.server.CraftBlock.WOOD.id, 5, 20);
        this.a(net.minecraft.server.CraftBlock.FENCE.id, 5, 20);
        this.a(net.minecraft.server.CraftBlock.WOOD_STAIRS.id, 5, 20);
        this.a(net.minecraft.server.CraftBlock.LOG.id, 5, 5);
        this.a(net.minecraft.server.CraftBlock.LEAVES.id, 30, 60);
        this.a(net.minecraft.server.CraftBlock.BOOKSHELF.id, 30, 20);
        this.a(net.minecraft.server.CraftBlock.TNT.id, 15, 100);
        this.a(net.minecraft.server.CraftBlock.LONG_GRASS.id, 60, 100);
        this.a(net.minecraft.server.CraftBlock.WOOL.id, 30, 60);
    }
    ...
    public void a(World world, int i, int j, int k, Random random) {
        boolean flag = world.getTypeId(i, j - 1, k) == net.minecraft.server.CraftBlock.NETHERRACK.id;
                            ...
                            if (i1 != i || k1 != j || j1 != k) {
                                ...
                                if (i2 > 0) {
                                    ...
                                    if (j2 > 0 && random.nextInt(l1) <= j2 && (!world.v() || !world.s(i1, k1, j1)) && !world.s(i1 - 1, k1, k) && !world.s(i1 + 1, k1, j1) && !world.s(i1, k1, j1 - 1) && !world.s(i1, k1, j1 + 1)) {
                                        ...
                                        if (block.getTypeId() != net.minecraft.server.CraftBlock.FIRE.id) {
    ...
    private void a(World world, int i, int j, int k, int l, Random random, int i1) {
        ...
        if (random.nextInt(l) < j1) {
            boolean flag = world.getTypeId(i, j, k) == net.minecraft.server.CraftBlock.TNT.id;
            // CraftBukkit start
            ...
            if (flag) {
                net.minecraft.server.CraftBlock.TNT.postBreak(world, i, j, k, 1);
            }
        }
    }
    ...
    public void c(World world, int i, int j, int k) {
        if (world.getTypeId(i, j - 1, k) != net.minecraft.server.CraftBlock.OBSIDIAN.id || !CraftBlock.PORTAL.a_(world, i, j, k)) {
            if (!world.e(i, j - 1, k) && !this.g(world, i, j, k)) {
                world.setTypeId(i, j, k, 0);
            } else {
                world.c(i, j, k, this.id, this.c());
