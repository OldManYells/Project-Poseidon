...
public class BlockStairs extends net.minecraft.server.CraftBlock {

    private net.minecraft.server.CraftBlock a;

    public BlockStairs(int i, CraftBlock block) {
        super(i, block.textureId, block.material);
        this.a = block;
        this.c(block.getStrength());
