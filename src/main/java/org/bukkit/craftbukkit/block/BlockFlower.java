...
public class BlockFlower extends net.minecraft.server.CraftBlock {
    ...
    protected boolean c(int i) {
        return i == net.minecraft.server.CraftBlock.GRASS.id || i == net.minecraft.server.CraftBlock.DIRT.id || i == CraftBlock.SOIL.id;
    }
