...
public abstract class BlockFluids extends net.minecraft.server.CraftBlock {
        ...
        if (world.getTypeId(i, j, k) == this.id) {
            if (this.material == Material.LAVA) {
                ...
                if (flag) {
                    ...
                    if (l == 0) {
                        world.setTypeId(i, j, k, net.minecraft.server.CraftBlock.OBSIDIAN.id);
                    } else if (l <= 4) {
                        world.setTypeId(i, j, k, CraftBlock.COBBLESTONE.id);
                    }
