...
public class BlockMinecartTrack extends net.minecraft.server.CraftBlock {
    ...
    public static final boolean g(World world, int i, int j, int k) {
        ...
        return l == net.minecraft.server.CraftBlock.RAILS.id || l == net.minecraft.server.CraftBlock.GOLDEN_RAIL.id || l == net.minecraft.server.CraftBlock.DETECTOR_RAIL.id;
    }

    public static final boolean c(int i) {
        return i == net.minecraft.server.CraftBlock.RAILS.id || i == net.minecraft.server.CraftBlock.GOLDEN_RAIL.id || i == net.minecraft.server.CraftBlock.DETECTOR_RAIL.id;
    }

    public BlockMinecartTrack(int i, int j, boolean flag) {
    ...
    public int a(int i, int j) {
        if (this.a) {
            if (this.id == net.minecraft.server.CraftBlock.GOLDEN_RAIL.id && (j & 8) == 0) {
    ...
    public void doPhysics(World world, int i, int j, int k, int l) {
        if (!world.isStatic) {
            ...
            } else if (this.id == net.minecraft.server.CraftBlock.GOLDEN_RAIL.id) {
            ...
            } else if (l > 0 && net.minecraft.server.CraftBlock.byId[l].isPowerSource() && !this.a && (new MinecartTrackLogic(this, world, i, j, k)).b() == 3) {
    ...
    private boolean a(World world, int i, int j, int k, boolean flag, int l, int i1) {
        ...
        if (j1 == CraftBlock.GOLDEN_RAIL.id) {
