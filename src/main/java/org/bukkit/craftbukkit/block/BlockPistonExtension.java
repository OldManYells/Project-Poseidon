...
public class BlockPistonExtension extends net.minecraft.server.CraftBlock {
    ...
    public void remove(World world, int i, int j, int k) {
        ...
        if (j1 == net.minecraft.server.CraftBlock.PISTON.id || j1 == net.minecraft.server.CraftBlock.PISTON_STICKY.id) {
            l = world.getData(i, j, k);
            if (BlockPiston.d(l)) {
                net.minecraft.server.CraftBlock.byId[j1].g(world, i, j, k, l);
    ...
    public void doPhysics(World world, int i, int j, int k, int l) {
        ...
        if (j1 != net.minecraft.server.CraftBlock.PISTON.id && j1 != net.minecraft.server.CraftBlock.PISTON_STICKY.id) {
            ...
            CraftBlock.byId[j1].doPhysics(world, i - PistonBlockTextures.b[i1], j - PistonBlockTextures.c[i1], k - PistonBlockTextures.d[i1], l);
        }
    }
