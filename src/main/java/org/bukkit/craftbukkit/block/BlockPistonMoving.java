...
public class BlockPistonMoving extends BlockContainer {
    ...
    public void dropNaturally(World world, int i, int j, int k, int l, float f) {
        if (!world.isStatic) {
            ...
            if (tileentitypiston != null) {
                net.minecraft.server.CraftBlock.byId[tileentitypiston.a()].g(world, i, j, k, tileentitypiston.e());
            }
        }
    }
    ...
    public void a(IBlockAccess iblockaccess, int i, int j, int k) {
        ...
        if (tileentitypiston != null) {
            net.minecraft.server.CraftBlock block = net.minecraft.server.CraftBlock.byId[tileentitypiston.a()];
    ...
    public AxisAlignedBB a(World world, int i, int j, int k, int l, float f, int i1) {
        if (l != 0 && l != this.id) {
            AxisAlignedBB axisalignedbb = CraftBlock.byId[l].e(world, i, j, k);
