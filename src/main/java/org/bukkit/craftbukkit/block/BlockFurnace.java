...
public class BlockFurnace extends BlockContainer {
    ...
    public int a(int i, Random random) {
        return net.minecraft.server.CraftBlock.FURNACE.id;
    }
    ...
    private void g(World world, int i, int j, int k) {
        if (!world.isStatic) {
            ...
            if (net.minecraft.server.CraftBlock.o[l] && !net.minecraft.server.CraftBlock.o[i1]) {
                b0 = 3;
            }

            if (net.minecraft.server.CraftBlock.o[i1] && !net.minecraft.server.CraftBlock.o[l]) {
                b0 = 2;
            }

            if (net.minecraft.server.CraftBlock.o[j1] && !net.minecraft.server.CraftBlock.o[k1]) {
                b0 = 5;
            }

            if (net.minecraft.server.CraftBlock.o[k1] && !net.minecraft.server.CraftBlock.o[j1]) {
                b0 = 4;
            }
    ...
    public static void a(boolean flag, World world, int i, int j, int k) {
        ...
        c = true;
        if (flag) {
            world.setTypeId(i, j, k, net.minecraft.server.CraftBlock.BURNING_FURNACE.id);
        } else {
            world.setTypeId(i, j, k, CraftBlock.FURNACE.id);
        }
