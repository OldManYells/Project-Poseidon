...
public class BlockPiston extends net.minecraft.server.CraftBlock {
    ...
    public void a(World world, int i, int j, int k, int l, int i1) {
        ...
        if (l == 0) {
            ...
            world.setRawTypeIdAndData(i, j, k, net.minecraft.server.CraftBlock.PISTON_MOVING.id, i1);
            ...
            if (this.a) {
                ...
                if (i2 == net.minecraft.server.CraftBlock.PISTON_MOVING.id) {
                ...
                if (!flag && i2 > 0 && a(i2, world, j1, k1, l1, false) && (net.minecraft.server.CraftBlock.byId[i2].e() == 0 || i2 == net.minecraft.server.CraftBlock.PISTON.id || i2 == net.minecraft.server.CraftBlock.PISTON_STICKY.id)) {
                    this.b = false;
                    ...
                    world.setRawTypeIdAndData(i, j, k, net.minecraft.server.CraftBlock.PISTON_MOVING.id, j2);
    ...
    private static boolean a(int i, World world, int j, int k, int l, boolean flag) {
        if (i == net.minecraft.server.CraftBlock.OBSIDIAN.id) {
            return false;
        } else if ((i == net.minecraft.server.CraftBlock.FURNACE.id || i == net.minecraft.server.CraftBlock.BURNING_FURNACE.id) && PoseidonConfig.getInstance().getBoolean("world.settings.block-pistons-pushing-furnaces.enabled", true)) {
//            System.out.println("Blocking a piston from being pushed.");
            return false;
        } else {
            if (i != net.minecraft.server.CraftBlock.PISTON.id && i != net.minecraft.server.CraftBlock.PISTON_STICKY.id) {
                if (net.minecraft.server.CraftBlock.byId[i].getStrength() == -1.0F) {
                    return false;
                }

                if (net.minecraft.server.CraftBlock.byId[i].e() == 2) {
                    return false;
                }

                if (!flag && net.minecraft.server.CraftBlock.byId[i].e() == 1) {
                    return false;
                }
        ...
        while (true) {
            if (l1 < 13) {
                ...
                if (i2 != 0) {
                    ...
                    if (net.minecraft.server.CraftBlock.byId[i2].e() != 1) {
                        if (l1 == 12) {
                            return -1; // CraftBukkit
                        }
        ...
        while (true) {
            ...
            if (l1 < 13) {
                ...
                if (i2 != 0) {
                    ...
                    net.minecraft.server.CraftBlock.byId[i2].g(world, i1, j1, k1, world.getData(i1, j1, k1));
            ...
            while (i1 != i || j1 != j || k1 != k) {
                ...
                if (k2 == this.id && l1 == i && i2 == j && j2 == k) {
                    world.setRawTypeIdAndData(i1, j1, k1, net.minecraft.server.CraftBlock.PISTON_MOVING.id, l | (this.a ? 8 : 0));
                    world.setTileEntity(i1, j1, k1, BlockPistonMoving.a(net.minecraft.server.CraftBlock.PISTON_EXTENSION.id, l | (this.a ? 8 : 0), l, true, false));
                } else {
                    world.setRawTypeIdAndData(i1, j1, k1, CraftBlock.PISTON_MOVING.id, l2);
