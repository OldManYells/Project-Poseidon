...
public class BlockFlowing extends BlockFluids {
        ...
        if (this.l(world, i, j, k)) {
            ...
            if (i1 > 0) {
                if (this.material == Material.LAVA) {
                    ...
                    net.minecraft.server.CraftBlock.byId[i1].g(world, i, j, k, world.getData(i, j, k));
                }
            }
    ...
    private boolean k(World world, int i, int j, int k) {
        ...
        if (l != net.minecraft.server.CraftBlock.WOODEN_DOOR.id && l != net.minecraft.server.CraftBlock.IRON_DOOR_BLOCK.id && l != net.minecraft.server.CraftBlock.SIGN_POST.id && l != net.minecraft.server.CraftBlock.LADDER.id && l != net.minecraft.server.CraftBlock.SUGAR_CANE_BLOCK.id) {
            if (l == 0) {
                return false;
            } else {
                Material material = CraftBlock.byId[l].material;
