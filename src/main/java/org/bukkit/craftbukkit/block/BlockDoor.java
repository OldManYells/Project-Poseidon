...
public class BlockDoor extends net.minecraft.server.CraftBlock {
    ...
    public void doPhysics(World world, int i, int j, int k, int l) {
        ...
        if ((i1 & 8) != 0) {
            ...
            if (l > 0 && net.minecraft.server.CraftBlock.byId[l].isPowerSource()) {
            ...
            } else if (l > 0 && CraftBlock.byId[l].isPowerSource()) {
                // CraftBukkit start
