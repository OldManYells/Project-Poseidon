...
public class BlockTrapdoor extends net.minecraft.server.CraftBlock {
    ...
    public void doPhysics(World world, int i, int j, int k, int l) {
        if (!world.isStatic) {
            ...
            // CraftBukkit start
            if (l > 0 && net.minecraft.server.CraftBlock.byId[l] != null && net.minecraft.server.CraftBlock.byId[l].isPowerSource()) {
    ...
    public void postPlace(World world, int i, int j, int k, int l) {
        ...
        doPhysics(world, i, j, k, CraftBlock.REDSTONE_WIRE.id); // CraftBukkit
    }
