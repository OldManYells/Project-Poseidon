...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    public int a(int i, int j) {
        return i == 1 ? net.minecraft.server.CraftBlock.REDSTONE_WIRE.a(i, j) : super.a(i, j);
    }
    ...
    public void a(World world, int i, int j, int k, Random random) {
        ...
        if (this.isOn) {
            if (flag) {
                ...
                world.setTypeIdAndData(i, j, k, net.minecraft.server.CraftBlock.REDSTONE_TORCH_OFF.id, world.getData(i, j, k));
            ...
            world.setTypeIdAndData(i, j, k, net.minecraft.server.CraftBlock.REDSTONE_TORCH_ON.id, world.getData(i, j, k));
        }
    }
    ...
    public int a(int i, Random random) {
        return CraftBlock.REDSTONE_TORCH_ON.id;
    }
