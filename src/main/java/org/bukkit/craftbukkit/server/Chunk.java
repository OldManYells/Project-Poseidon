...
public class Chunk {
    ...
    public void initLighting() {
        ...
        for (j = 0; j < 16; ++j) {
            for (k = 0; k < 16; ++k) {
                ...
                for (i1 = j << 11 | k << 7; l > 0 && net.minecraft.server.CraftBlock.q[this.b[i1 + l - 1] & 255] == 0; --l) {
                    ;
                }
                ...
                if (!this.world.worldProvider.e) {
                    ...
                    do {
                        j1 -= net.minecraft.server.CraftBlock.q[this.b[i1 + k1] & 255];
                        if (j1 > 0) {
                            this.f.a(j, k1, k, j1);
                        }
    ...
    private void g(int i, int j, int k) {
        ...
        for (int j1 = i << 11 | k << 7; i1 > 0 && net.minecraft.server.CraftBlock.q[this.b[j1 + i1 - 1] & 255] == 0; --i1) {
            ;
        }
        ...
        if (i1 != l) {
            ...
            for (j2 = i1; i1 > 0 && i2 > 0; this.f.a(i, i1, k, i2)) {
                --i1;
                int k2 = net.minecraft.server.CraftBlock.q[this.getTypeId(i, i1, k)];
            ...
            while (i1 > 0 && net.minecraft.server.CraftBlock.q[this.getTypeId(i, i1 - 1, k)] == 0) {
                --i1;
            }
        ...
        if (k1 == l && this.e.a(i, j, k) == i1) {
            ...
            if (PoseidonConfig.getInstance().getConfigBoolean("world.settings.pistons.transmutation-fix.enabled", true)) {
                ...
                if (k1 != 0 && !this.world.isStatic) {
                    net.minecraft.server.CraftBlock.byId[k1].remove(this.world, l1, j, i2);
                }
            } else {
                if (k1 != 0 && !this.world.isStatic) {
                    net.minecraft.server.CraftBlock.byId[k1].remove(this.world, l1, j, i2);
            ...
            if (!this.world.worldProvider.e) {
                if (net.minecraft.server.CraftBlock.q[b0 & 255] != 0) {
                    if (j >= j1) {
                        this.g(i, j + 1, k);
                    }
                } else if (j == j1 - 1) {
            ...
            this.c(i, k);
            if (l != 0) {
                net.minecraft.server.CraftBlock.byId[l].c(this.world, l1, j, i2);
            }
    ...
    public boolean a(int i, int j, int k, int l) {
        ...
        if (j1 == l) {
            ...
            this.b[i << 11 | k << 7 | j] = (byte) (b0 & 255);
            if (j1 != 0) {
                net.minecraft.server.CraftBlock.byId[j1].remove(this.world, k1, j, l1);
            }
            ...
            if (l != 0 && !this.world.isStatic) {
                net.minecraft.server.CraftBlock.byId[l].c(this.world, k1, j, l1);
            }
    ...
    public TileEntity d(int i, int j, int k) {
        ...
        if (tileentity == null) {
            ...
            if (!net.minecraft.server.CraftBlock.isTileEntity[l]) {
                return null;
            }

            BlockContainer blockcontainer = (BlockContainer) net.minecraft.server.CraftBlock.byId[l];
    ...
    public void placeTileEntity(int i, int j, int k, TileEntity tileentity) {
        ...
        if (this.getTypeId(i, j, k) != 0 && net.minecraft.server.CraftBlock.byId[this.getTypeId(i, j, k)] instanceof BlockContainer) {
            tileentity.j();
