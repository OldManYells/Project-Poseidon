...
public class CraftItemStack extends ItemStack {
    protected org.bukkit.craftbukkit.item.ItemStack item;

    public CraftItemStack(org.bukkit.craftbukkit.item.ItemStack item) {
        super(
            item != null ? item.id: 0,
    ...
    public CraftItemStack(int type, int amount, short damage, Byte data) {
        this(new org.bukkit.craftbukkit.item.ItemStack(type, amount, data != null ? data : damage));
    }
    ...
    public void setTypeId(int type) {
        if (type == 0) {
            ...
            if (item == null) {
                item = new org.bukkit.craftbukkit.item.ItemStack(type, 1, 0);
                super.setAmount(1);
            } else {
                item.id = type;
