...
public class CraftItemStack extends ItemStack {
    protected com.legacy.minecraft.poseidon.ItemStack item;

    public CraftItemStack(com.legacy.minecraft.poseidon.ItemStack item) {
        super(
            item != null ? item.id: 0,
    ...
    public CraftItemStack(int type, int amount, short damage, Byte data) {
        this(new com.legacy.minecraft.poseidon.ItemStack(type, amount, data != null ? data : damage));
    }
    ...
    public void setTypeId(int type) {
        if (type == 0) {
            ...
            if (item == null) {
                item = new com.legacy.minecraft.poseidon.ItemStack(type, 1, 0);
                super.setAmount(1);
            } else {
                item.id = type;
