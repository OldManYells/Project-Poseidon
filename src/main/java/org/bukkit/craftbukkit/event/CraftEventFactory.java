...
public class CraftEventFactory {
    ...
    public static BlockPlaceEvent callBlockPlaceEvent(World world, EntityHuman who, BlockState replacedBlockState, int clickedX, int clickedY, int clickedZ, int type) {
        return callBlockPlaceEvent(world, who, replacedBlockState, clickedX, clickedY, clickedZ, com.legacyminecraft.poseidon.world.block.Block.byId[type]);
    }

    public static BlockPlaceEvent callBlockPlaceEvent(World world, EntityHuman who, BlockState replacedBlockState, int clickedX, int clickedY, int clickedZ, com.legacyminecraft.poseidon.world.block.Block block) {
    ...
    public static PlayerBucketFillEvent callPlayerBucketFillEvent(EntityHuman who, int clickedX, int clickedY, int clickedZ, int clickedFace, ItemStack itemInHand, com.legacyminecraft.poseidon.world.item.Item bucket) {
    ...
    private static PlayerEvent getPlayerBucketEvent(Type type, EntityHuman who, int clickedX, int clickedY, int clickedZ, int clickedFace, ItemStack itemstack, com.legacyminecraft.poseidon.world.item.Item item) {
        Player player = (who == null) ? null : (Player) who.getBukkitEntity();
