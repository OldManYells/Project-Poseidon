...
public class EntityEgg extends Entity {
    ...
    public void m_() {
        ...
        if (!this.world.isStatic) {
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                if (entity1.l_() && (entity1 != this.thrower || this.ticksInAir >= 5)) {
                    float f = 0.3F;
    ...
    public void b(EntityHuman entityhuman) {
        if (this.inGround && this.thrower == entityhuman && this.shake <= 0 && entityhuman.inventory.pickup(new ItemStack(Item.ARROW, 1))) {
