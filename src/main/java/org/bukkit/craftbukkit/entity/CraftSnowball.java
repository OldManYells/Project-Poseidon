...
public class CraftSnowball extends AbstractProjectile implements Snowball {
    ...
    public String toString() {
        return ENTITY_WRAPPER_STRING_BEHAVIOUR.toString("CraftSnowball");
    }

    public LivingEntity getShooter() {
        return (LivingEntity) PROJECTILE_SHOOTER_ASSIGNMENT_BEHAVIOUR.toBukkitShooter(
                PROJECTILE_ENTITY_SHOOTER_FIELD_BEHAVIOUR.getSnowballShooter(getSnowballHandle()),
        ...
        PROJECTILE_SHOOTER_ASSIGNMENT_BEHAVIOUR.assignShooter(
                ...
                new ProjectileShooterAssignmentBehaviour.ShooterAssignment() {
                    ...
                    public void assign(Object shooterEntity) {
                        PROJECTILE_ENTITY_SHOOTER_FIELD_BEHAVIOUR.setSnowballShooter(
                                getSnowballHandle(),
                                (net.minecraft.server.EntityLiving) shooterEntity
                        );
                    }
    ...
    private EntitySnowball getSnowballHandle() {
        return ENTITY_TYPED_HANDLE_CAST_BEHAVIOUR.castHandle(entity, EntitySnowball.class);
    }
}
