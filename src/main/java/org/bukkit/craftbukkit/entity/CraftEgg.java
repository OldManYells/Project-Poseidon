...
public class CraftEgg extends AbstractProjectile implements Egg {
    ...
    public String toString() {
        return ENTITY_WRAPPER_STRING_BEHAVIOUR.toString("CraftEgg");
    }

    public LivingEntity getShooter() {
        return (LivingEntity) PROJECTILE_SHOOTER_ASSIGNMENT_BEHAVIOUR.toBukkitShooter(
                PROJECTILE_ENTITY_SHOOTER_FIELD_BEHAVIOUR.getEggThrower(getEggHandle()),
        ...
        PROJECTILE_SHOOTER_ASSIGNMENT_BEHAVIOUR.assignShooter(
                ...
                new ProjectileShooterAssignmentBehaviour.ShooterAssignment() {
                    ...
                    public void assign(Object shooterEntity) {
                        PROJECTILE_ENTITY_SHOOTER_FIELD_BEHAVIOUR.setEggThrower(
                                getEggHandle(),
                                (net.minecraft.server.EntityLiving) shooterEntity
                        );
                    }
    ...
    private EntityEgg getEggHandle() {
        return ENTITY_TYPED_HANDLE_CAST_BEHAVIOUR.castHandle(entity, EntityEgg.class);
    }
}
