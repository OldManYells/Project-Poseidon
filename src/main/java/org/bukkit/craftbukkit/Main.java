...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (options.has("v")) {
            Package bootstrapPackage = Main.class.getPackage();
            String implementationVersion = bootstrapPackage == null ? null : bootstrapPackage.getImplementationVersion();
            System.out.println(implementationVersion == null ? "unknown" : implementationVersion);
            return;
        }
