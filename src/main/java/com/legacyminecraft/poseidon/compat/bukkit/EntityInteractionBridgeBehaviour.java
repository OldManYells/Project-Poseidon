...
public final class EntityInteractionBridgeBehaviour {
    ...
    public List<org.bukkit.entity.Entity> collectNearbyEntities(Entity sourceEntity, double x, double y, double z) {
        @SuppressWarnings("unchecked")
        List<Entity> nearbyNotchEntities = sourceEntity.world.b(sourceEntity, sourceEntity.boundingBox.b(x, y, z));
        List<org.bukkit.entity.Entity> nearbyBukkitEntities =
                new ArrayList<org.bukkit.entity.Entity>(nearbyNotchEntities.size());
    ...
    public org.bukkit.entity.Entity getPassenger(Entity sourceEntity) {
    ...
    public boolean setPassenger(Entity sourceEntity, org.bukkit.entity.Entity bukkitPassenger) {
