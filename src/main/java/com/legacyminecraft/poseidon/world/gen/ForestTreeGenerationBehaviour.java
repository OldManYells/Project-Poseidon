...
public final class ForestTreeGenerationBehaviour {
    private static final ForestTreeGenerationBehaviour INSTANCE = new ForestTreeGenerationBehaviour();

    private ForestTreeGenerationBehaviour() {
    }

    public static ForestTreeGenerationBehaviour getInstance() {
        return INSTANCE;
    }
