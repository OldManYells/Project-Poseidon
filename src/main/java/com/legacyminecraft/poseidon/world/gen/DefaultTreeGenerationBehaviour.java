...
public final class DefaultTreeGenerationBehaviour {
    private static final DefaultTreeGenerationBehaviour INSTANCE = new DefaultTreeGenerationBehaviour();

    private DefaultTreeGenerationBehaviour() {
    }

    public static DefaultTreeGenerationBehaviour getInstance() {
        return INSTANCE;
    }
