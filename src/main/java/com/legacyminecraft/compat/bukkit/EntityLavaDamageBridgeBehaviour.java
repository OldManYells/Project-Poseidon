...
public final class EntityLavaDamageBridgeBehaviour {
    ...
    public LavaContactResult resolveLavaContact(Entity entity, int currentFireTicks) {
        ...
        com.legacyminecraft.compat.bukkit.Server server = entity.world.getServer();
        com.legacyminecraft.compat.bukkit.block.Block damager = null;
        com.legacyminecraft.compat.bukkit.Entity damagee = entity.getBukkitEntity();
