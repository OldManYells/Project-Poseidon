...
public final class WolfStateBehaviour {
    ...
    public AnimalTamer refreshOwnerCache(AnimalTamer cachedOwner, Server server, String ownerName) {
        return resolveOwner(cachedOwner, server, ownerName);
    }

    public AnimalTamer getOwnerForView(AnimalTamer cachedOwner) {
        return cachedOwner;
    }
