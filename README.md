...
- **Inventory Block Duplication Fixes:** Includes fixes for chest, furnace, inventory baseBlock duplication, and Minecart duplication issues.
...
- **Tree Growth Blockage Settings:** Allows server owners to baseBlock tree growth from replacing certain blocks to prevent griefing.
...
- **Spawn Location Options:** Provides options to disable spawn location randomization and teleportation to the highest safe baseBlock on join.
